...
export const Card = ({ data }) => {
  ...
  return (
    <div className="container mx-auto p-2 mx-3 flex flex-wrap">
      <div className=" container max-w-sm bg-white border border-blue-900 rounded-lg shadow bg-gray-200 CARD transition ease-in-out delay-150 bg-gray-200 hover:-translate-y-1 hover:scale-110  duration-300 ...">
        <Link to={`/data/${id}`}>
          <img
        ...
        <div className="px-5 pb-5">
          ...
          <div className="relative flex self-center mt-2.5 mb-5 ">
            <svg
