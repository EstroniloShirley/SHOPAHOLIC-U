        ...
        <div className="About bg-gray-300 rounded-lg p-8 shadow-md">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <p className=" text-black-700 text-lg leading-7 inline-block align-middle ">
              ...
              high-quality beauty and makeup products. Founded by the dedicated
              team of Shirley Calaunan Macaraeg-Estronilo and Mark Lorenze
              Borleo, we bring you a meticulously curated collection of items,
              including the latest trends in men's and women's clothing,
              exquisite jewelry, cutting-edge electronics, and so much more.
              Explore our extensive range of beauty and makeup products to
              enhance your natural beauty and elevate your style.
            </p>
          </div>
          <div className=" grid grid-cols-2 gap-4">
            <p className="text-black-700 mt-6 text-lg leading-7">
              Our mission is to provide our valued customers with nothing but
              the best – from exceptional products and top-notch customer
              service to a seamless shopping experience. At Shopaholic-U, we are
              committed to offering you the latest trends, ensuring top-quality,
              and providing affordability to ensure you find the perfect items
              to match your unique style and meet your every need.
            </p>
            <img
              src={ImgAbout2}
              alt="About Logo1"
